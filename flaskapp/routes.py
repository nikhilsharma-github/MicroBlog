...
from flaskapp.forms import LoginForm, RegistrationForm, EditProfileForm, PostForm, ResetPasswordRequestForm, ResetPasswordForm, EmptyForm
...
def login():
    ...
    return render_template('login.html', title=_('Sign In'), form=loginform)
...
def register():
    ...
    if registrationform.validate_on_submit():
        ...
        return redirect(url_for('login'))
    return render_template('register.html',title=_('Register'), form=registrationform)
